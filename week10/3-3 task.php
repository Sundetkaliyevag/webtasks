...
<select name="car" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">
        <option value="" selected disabled hidden>Choose a car</option>
        <option value="task31.php">Ferrari F12 Berlinetta (2016)</option>
        <option value="task32.php">Lexus IS300 (2018)</option>
        <option value="task33.php">BMW M5 (2018)</option>
      </select>  
    </form>
